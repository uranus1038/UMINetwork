...
public class SheepEquipment : MonoBehaviour
{
	...
	private void EquipArmor(string nArmor)
	{
		...
		skinnedMeshRenderer.sharedMesh = SheepEquipment.getEquipArmorMash(nArmor);
		skinnedMeshRenderer.material = SheepEquipment.getEquipArmorMaterial(nArmor);
	...
	private static Material getEquipArmorMaterial(string nArmorMaterial)
	{
		...
		Texture2D texture2D = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Sheep/Armors/Overlay/Sheep1", typeof(Texture2D));
		Color[] pixels = texture2D.GetPixels(0);
		switch (nArmorMaterial)
		{
			case "a_all1":
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Sheep/Armors/Materials/Sheep_scout1", typeof(Texture2D));
				break;
			default:
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Sheep/Armors/Materials/Sheep_nude1", typeof(Texture2D));
				break;
		}
	...
	private static Mesh getEquipArmorMash(string nArmorMash)
	{
		...
		{
			case "a_all1":
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Sheep/Armors/Sheep_scout", typeof(GameObject));
				break;
			default:
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Sheep/Armors/Sheep_nude", typeof(GameObject));
				break;
		}
	...
	private static GameObject getEquipWeapon(string nWeapon)
	{
		...
		{
			case "w_shp1":
				result = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Sheep/Weapons/noviceBook", typeof(GameObject));
				break;
			default:
				result = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Sheep/Weapons/commonBook", typeof(GameObject));
				break;
		}
		return result;
	}
