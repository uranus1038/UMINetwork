...
public class MonkeyEquipment : MonoBehaviour
{
	...
	private void EquipArmor(string nArmor)
	{
		...
		skinnedMeshRenderer.sharedMesh = MonkeyEquipment.getEquipArmorMash(nArmor);
		skinnedMeshRenderer.material = MonkeyEquipment.getEquipArmorMaterial(nArmor);
	...
	private static Material getEquipArmorMaterial(string nArmorMaterial)
	{
		...
		Texture2D texture2D = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Monkey/Armors/Overlay/Monkey1", typeof(Texture2D));
		Color[] pixels = texture2D.GetPixels(0);
		switch (nArmorMaterial)
		{
			case "a_all1":
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Monkey/Armors/Materials/Monkey_scout1", typeof(Texture2D));
				break;
			default:
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Monkey/Armors/Materials/Monkey_nude1", typeof(Texture2D));
				break;
		}
	...
	private static Mesh getEquipArmorMash(string nArmorMash)
	{
		...
		{
			case "a_all1":
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Monkey/Armors/Monkey_scout", typeof(GameObject));
				break;
			default:
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Monkey/Armors/Monkey_nude", typeof(GameObject));
				break;
		}
