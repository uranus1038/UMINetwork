...
public class BatEquipment : MonoBehaviour
{
	...
	private void EquipArmor(string nArmor)
	{
		...
		skinnedMeshRenderer.sharedMesh = BatEquipment.getEquipArmorMash(nArmor);
		skinnedMeshRenderer.material = BatEquipment.getEquipArmorMaterial(nArmor);
	...
	private static Material getEquipArmorMaterial(string nArmorMaterial)
    {
		...
		Texture2D texture2D = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Bat/Armors/Overlay/Bat1" ,typeof(Texture2D));
		Color[] pixels = texture2D.GetPixels(0);
		switch (nArmorMaterial)
		{
			case "a_all1":
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Bat/Armors/Materials/Bat_scout1" , typeof(Texture2D)); 
				break;
			default:
				texture2D2 = (Texture2D)Resources.Load("GameAssets/Characters/Heroes/Bat/Armors/Materials/Bat_nude1" , typeof(Texture2D));
				break;
		}
	...
	private static Mesh  getEquipArmorMash(string nArmorMash)
	{
		...
		{
			case "a_all1":
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Bat/Armors/Bat_scout", typeof(GameObject));
				break;
			default:
				nArmor_0 = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Bat/Armors/Bat_nude", typeof(GameObject));
				break;
		}
	...
	private static GameObject getEquipWeapon(string nWeapon)
	{
		...
		switch (nWeapon)
		{
			case "w_bat1":
				...
				break;
			default: result = (GameObject)Resources.Load("GameAssets/Characters/Heroes/Bat/Weapons/standardWand", typeof(GameObject));
				break;
		}
		return result;
	}
